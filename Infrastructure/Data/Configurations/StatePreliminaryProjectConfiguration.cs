...
{
    public class StatePreliminaryProjectConfiguration : BaseEntityConfiguration<StatePreliminaryProject, int>
    {
        public override void Configure(EntityTypeBuilder<StatePreliminaryProject> builder)
        {
            base.Configure(builder);
            builder.ToTable("StatePreliminaryProject");
