...
{
    public class SeminarRepository : BaseRepository<Seminar, int>, ISeminarRepository
    {
        public SeminarRepository(AppDbContext context) : base(context)
        {
        }

        public async Task<SeminarWithDetails?> GetWithDetailsAsync(int id)
        {
            var entity = await _context.Seminars
        ...
        public async Task<PaginatedResult<SeminarWithDetails>> GetAllWithDetailsPaginatedAsync(
            int pageNumber, 
            int pageSize, 
            string sortBy, 
            bool isDescending, 
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.ApplyFilters<Seminar, int>(filters);
        ...
        public async Task<List<SeminarWithDetails>> GetByUserAsync(int userId, bool? status = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<PaginatedResult<SeminarWithDetails>> GetByTeacherAsync(
            int teacherId,
            int pageNumber, 
            int pageSize, 
            string sortBy, 
        ...
        private async Task<SeminarWithDetails> PopulateDetails(Seminar entity, CancellationToken cancellationToken = default)
        {
        ...
        private IQueryable<Seminar> ApplySpecificFilters(IQueryable<Seminar> query, Dictionary<string, string> filters)
        {
