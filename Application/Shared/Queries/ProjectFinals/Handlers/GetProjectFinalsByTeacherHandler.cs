                ...
                {                    ProjectFinal = new ProjectFinalDetailsDto
                    {
                        ...
                        StateStage = e.Project.StateStage != null ? new Application.Shared.DTOs.StateStages.StateStageDto
                        {
                    ...
                    {                        Proposal = new ProposalDto
                        ...
                        Students = e.Students.Select(uim => new Application.Shared.DTOs.UserInscriptionModalities.UserInscriptionModalityDto
                        {
                            Id = uim.Id,
