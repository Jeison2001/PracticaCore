...
namespace Tests.Integration.PreliminaryProjects
{
    public class PreliminaryProjectControllerTests : GenericControllerIntegrationTests<PreliminaryProject, PreliminaryProjectDto>
    {
        ...
        protected override PreliminaryProject CreateValidEntity()
        {
            return new PreliminaryProject
            {
                Observations = "Test Observations",
                ApprovalDate = DateTime.Now
            };
        ...
        protected override void SeedAdditionalData(PreliminaryProject entity)
        {
        ...
        public override async Task GetAll_ReturnsOkAndList()
        {
            ...
            {
                var context = scope.ServiceProvider.GetRequiredService<AppDbContext>();
                context.Set<PreliminaryProject>().Add(entity);
