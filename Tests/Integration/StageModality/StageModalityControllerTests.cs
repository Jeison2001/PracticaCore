...
{
    public class StageModalityControllerTests : GenericControllerIntegrationTests<Domain.Entities.StageModality, StageModalityDto>
    {
        ...
        protected override void SeedAdditionalData(Domain.Entities.StageModality entity)
        {
        ...
        protected override Domain.Entities.StageModality CreateValidEntity()
        {
            return new Domain.Entities.StageModality
            {
