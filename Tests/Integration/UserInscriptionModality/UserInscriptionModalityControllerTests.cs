...
{
    public class UserInscriptionModalityControllerTests : GenericControllerIntegrationTests<Domain.Entities.UserInscriptionModality, UserInscriptionModalityDto>
    {
        ...
        protected override void SeedAdditionalData(Domain.Entities.UserInscriptionModality entity)
        {
            using (var scope = _factory.Services.CreateScope())
            {
                ...
                var inscriptionModality = new Domain.Entities.InscriptionModality 
                { 
                ...
                context.Set<Domain.Entities.InscriptionModality>().Add(inscriptionModality);
                context.SaveChanges();
        ...
        protected override Domain.Entities.UserInscriptionModality CreateValidEntity()
        {
            return new Domain.Entities.UserInscriptionModality
            {
                StatusRegister = true
