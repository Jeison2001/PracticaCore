...
namespace Tests.Integration.ProjectFinal
{
    public class ProjectFinalControllerTests : GenericControllerIntegrationTests<Domain.Entities.ProjectFinal, ProjectFinalDto>
    {
        ...
        protected override Domain.Entities.ProjectFinal CreateValidEntity()
        {
            return new Domain.Entities.ProjectFinal
            {
                Observations = "Test Observations",
                ReportApprovalDate = DateTime.Now
            };
        ...
        protected override void SeedAdditionalData(Domain.Entities.ProjectFinal entity)
        {
        ...
        public override async Task Update_ReturnsOk()
        {
            ...
            {
                var context = scope.ServiceProvider.GetRequiredService<AppDbContext>();
                context.Set<Domain.Entities.ProjectFinal>().Add(entity);
