...
{
    public class TeacherResearchProfileControllerTests : GenericControllerIntegrationTests<TeacherResearchProfile, TeacherResearchProfileDto>
    {
        ...
        protected override void SeedAdditionalData(TeacherResearchProfile entity)
        {
        ...
        protected override TeacherResearchProfile CreateValidEntity()
        {
            return new TeacherResearchProfile
            {
                ProfileDescription = "Test Profile",
                StatusRegister = true
            };
