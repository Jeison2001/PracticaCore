...
{
    public class InscriptionModalityControllerTests : GenericControllerIntegrationTests<Domain.Entities.InscriptionModality, InscriptionModalityDto>
    {
        ...
        protected override void SeedAdditionalData(Domain.Entities.InscriptionModality entity)
        {
        ...
        protected override Domain.Entities.InscriptionModality CreateValidEntity()
        {
            return new Domain.Entities.InscriptionModality
            {
                ApprovalDate = DateTime.Now,
                Observations = "Test Observation",
                StatusRegister = true
