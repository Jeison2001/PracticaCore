...
{
    public class ThematicAreaControllerTests : GenericControllerIntegrationTests<ThematicArea, ThematicAreaDto>
    {
        ...
        protected override void SeedAdditionalData(ThematicArea entity)
        {
        ...
        protected override ThematicArea CreateValidEntity()
        {
