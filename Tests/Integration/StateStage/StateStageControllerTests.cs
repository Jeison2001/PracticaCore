...
{
    public class StateStageControllerTests : GenericControllerIntegrationTests<Domain.Entities.StateStage, StateStageDto>
    {
        ...
        protected override void SeedAdditionalData(Domain.Entities.StateStage entity)
        {
        ...
        protected override Domain.Entities.StateStage CreateValidEntity()
        {
            return new Domain.Entities.StateStage
            {
