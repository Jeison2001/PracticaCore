...
{
    public class ResearchGroupControllerTests : GenericControllerIntegrationTests<Domain.Entities.ResearchGroup, ResearchGroupDto>
    {
        ...
        protected override Domain.Entities.ResearchGroup CreateValidEntity()
        {
            return new Domain.Entities.ResearchGroup
            {
