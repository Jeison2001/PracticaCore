...
{
    public class ProposalControllerTests : GenericControllerIntegrationTests<Domain.Entities.Proposal, ProposalDto>
    {
        ...
        protected override Domain.Entities.Proposal CreateValidEntity()
        {
        ...
        protected override void SeedAdditionalData(Domain.Entities.Proposal entity)
        {
        ...
        public override async Task Update_ReturnsOk()
        {
            ...
            {
                var context = scope.ServiceProvider.GetRequiredService<AppDbContext>();
                context.Set<Domain.Entities.Proposal>().Add(entity);
