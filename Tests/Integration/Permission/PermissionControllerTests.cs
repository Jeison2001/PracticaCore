...
{
    public class PermissionControllerTests : GenericControllerIntegrationTests<Domain.Entities.Permission, PermissionDto>
    {
        ...
        protected override Domain.Entities.Permission CreateValidEntity()
        {
        ...
        public override async Task Update_ReturnsOk()
        {
            ...
            using (var scope = _factory.Services.CreateScope())
            {
                ...
                context.Set<Domain.Entities.Permission>().Add(entity);
