...
{
    public class UserRoleControllerTests : GenericControllerIntegrationTests<UserRole, UserRoleDto>
    {
        ...
        protected override UserRole CreateValidEntity()
        {
            return new UserRole
            {
                IdUser = 0,
        ...
        protected override void SeedAdditionalData(UserRole entity)
        {
