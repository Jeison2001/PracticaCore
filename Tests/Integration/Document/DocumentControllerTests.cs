...
namespace Tests.Integration.Document
{
    public class DocumentControllerTests : IntegrationTestBase
    {
        ...
        public async Task UpdateStatus_ShouldReturnOk_WhenDocumentExists()
        {
            ...
            {
                var context = scope.ServiceProvider.GetRequiredService<AppDbContext>();
                var updatedDoc = await context.Set<Domain.Entities.Document>().FindAsync(docId);
        ...
        public async Task GetRequiredDocumentsByCurrentState_ShouldReturnList()
        {
            ...
            using (var scope = _factory.Services.CreateScope())
            {
                ...
                var academicPractice = new Domain.Entities.AcademicPractice
                {
                ...
                context.Set<Domain.Entities.AcademicPractice>().Add(academicPractice);
                await context.SaveChangesAsync();
